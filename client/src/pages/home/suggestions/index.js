        ...
        <div className=' Suggestion'>
           <div className="top">
                <div className="personal-profile">
                    <Person/>
                    <button className='button' type='button'> Switch </button>
                </div>
           </div>
           <div className="middle">
               ...
               <div className="second">
                   <div className="suggested-person">
                        <SuggestedPerson/>
                        <button  className='button' type='button'> Follow </button>
                   </div>
                   <div className="suggested-person">
                        <SuggestedPerson/>
                        <button className='button' type='button'> Follow </button>
               ...
               <div className="forth">
               <Button onClick={()=>{ dispatch(getPosts(token)); func()}} style ={ { margin: "0.5rem 0 1rem" }}  className='log-out' variant="outline-secondary">
                   Refresh
                </Button>
                <Button onClick={()=> dispatch(LogOut())} className='log-out' variant="danger">
                   <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 320.002 320.002" style={{enableBackground: "new 0 0 320.002 320.002"}} space="preserve">
                        <g id="XMLID_6_">
               ...
               <div className="third">
                   <p>© copyright 2021 By Dev Aymen.</p>
               </div>
...
function SuggestedPerson ({img=profil,name="Aymen Sedky",userName="Aymen_Sedky",followed="Yassin_sedky + 22 more"}){
    return(<>
        <a href={`/${userName}`} style={{textDecoration : "none"}}>
           <div className="person">
                <img src={img} alt="person" />
